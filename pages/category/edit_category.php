...
if(!$categoria) {
    header("location: category_panel.php?error=1");
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $updateQuery = "UPDATE category SET nameCategory = '$nombreCategoria' WHERE idCategory = $id";
    if(mysqli_query($conn, $updateQuery)) {
        header("location: category_panel.php?success=2");
    } else {
        $error = "Error al actualizar categoría: " . mysqli_error($conn);
    }
}
...
<body>
    ...
    <div class="breadcrumb">
        <span>Inicio > Centro de Cuentas > Panel de Administración > Categorías > Editar</span>
    </div>
                ...
                <form method="POST" class="category-form">
                    <div class="form-group">
                        ...
                        <input type="text" id="nameCategory" name="nameCategory" 
                               value="<?php echo htmlspecialchars($categoria['nameCategory']); ?>" required>
                    </div>
